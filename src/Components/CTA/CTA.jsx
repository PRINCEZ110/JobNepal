      ...
      <div className="cta-container">
        ...
        <div className="cta-grid">
          <div className="cta-card">
            ...
            <Link to="/find-job" className="cta-btn cta-btn--primary">Find Jobs <HiArrowRight /></Link>
          </div>
          <div className="cta-card">
            ...
            <Link to="/hire" className="cta-btn cta-btn--secondary">Post a Job <HiArrowRight /></Link>
          </div>
        </div>
      </div>
    </section>
